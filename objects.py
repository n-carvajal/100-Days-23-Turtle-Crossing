...
player_movement = mixer.Sound("player_move.wav")
...
class Background(Turtle):
    ...
    def grass(self):
        ...
        It does so by setting color() and trutlesize() attributes.
    ...
    def dashes(self):
        ...
        Once the 10 stamp() maneuvers have been completed on the x-axis it moves down on the y-axis by 150.
